...
### 6단계: CLI 버전 구현 ✅ (2025-08-29 완료)
- [x] CLI 아키텍처 설계
  - [x] 명령어 구조 설계
  - [x] BaseCommand 클래스 구현
- [x] 핵심 명령어 구현
  - [x] 대화형 모드 (interactive)
  - [x] 로그인 명령 (login)
  - [x] DB 선택 명령 (select-db)
  - [x] Issue 선택 명령 (select-issue)
  - [x] 설정 명령 (configure)
- [x] CLI 기능 구현
  - [x] 단계별 진행 표시
  - [x] 이전 단계로 돌아가기
